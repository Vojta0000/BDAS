...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_branch_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_branch_tree';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_user_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_client_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_teller_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_transaction_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_message_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_login_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW v_audit_overview';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF;
END;
/
